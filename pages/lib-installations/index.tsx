...
export default function LibInstallation() {
  const _API_URL = `${process.env.NEXT_PUBLIC_API_URL}/api/v1/staff/lib_installation`;
  const _PAGE_NAME = "Installation Libraries";
